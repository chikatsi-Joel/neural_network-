# Form implementation generated from reading ui file '/home/chikatsi/Bureau/INFOL3/DataSCience S2/interface.py/untitled.ui'
#
...
"}")
        ...
        self.atom = QtWidgets.QLabel(parent=self.container)
...
"border-radius: 10px;")
        ...
        self.frame_log = QtWidgets.QWidget(parent=self.container)
...
"border-radius: 10px;")
        ...
        self.name_title = QtWidgets.QLabel(parent=self.frame_log)
        ...
        self.name_title.setTextFormat(QtCore.Qt.TextFormat.MarkdownText)
        self.name_title.setScaledContents(True)
        self.name_title.setObjectName("name_title")
        self.nom_bas = QtWidgets.QLabel(parent=self.frame_log)
...
"background-color: transparent;")
        ...
        self.valider_connexion = QtWidgets.QPushButton(parent=self.container)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.container)
...
"padding: 5px;")
        ...
        self.name_label_2 = QtWidgets.QLabel(parent=self.gridFrame)
        font = QtGui.QFont()
        ...
        self.email_edit = QtWidgets.QLineEdit(parent=self.gridFrame)
...
"")
        ...
        self.name_edit = QtWidgets.QLineEdit(parent=self.gridFrame)
...
"")
        ...
        self.email_label = QtWidgets.QLabel(parent=self.gridFrame)
        font = QtGui.QFont()
        font.setFamily("Suranna")
        font.setPointSize(11)
        font.setBold(True)
